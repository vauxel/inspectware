...
export class Inspection {
    ...
    /**
     * Gets general information about an inspection
     * @param inspection the inspection document
     */
    public static async getGeneralInfo(inspection: Document) {
        ...
        return {
            ...
            realtor_selling: (inspection.get("realtor") ? {
                name: `${inspection.get("realtor.first_name")} ${inspection.get("realtor.last_name")}`
            } : null),
            realtor_buying: (inspection.get("realtor") ? {
                name: `${inspection.get("realtor.first_name")} ${inspection.get("realtor.last_name")}`
            } : null)
        };
    }
